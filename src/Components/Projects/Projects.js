  ...
  return (
    <div className='projects' id='projects'>
        ...
        <ProjectTile title="Overseer"
         ...
         link="https://github.com/saminahsan/Overseer.git"
         img={overseer}
         />
        ...
        <ProjectTile title="GameVault"
         ...
         tech="MySQL · Spring Boot · React.js · NextUI · CSS"
         link="https://github.com/saminahsan/CSE470-GameVault.git"
         img={gamevault}
         />
        ...
        <ProjectTile title="VaxTrak"
         ...
         link="https://github.com/aothoi/VaxTrak.git"
         img={vaxtrak}
         />

        <Link css={{fontFamily: "Rubik"}} block isExternal color="primary" href="https://github.com/saminahsan?tab=repositories" target="_blank">
